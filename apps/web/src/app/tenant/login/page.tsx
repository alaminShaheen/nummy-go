...
function VendorLoginContent() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div className="glow-indigo animate-pulse-glow"
                style={{ bottom: '-10%', right: '-10%', animationDelay: '1.5s' }} aria-hidden="true" />
          ...
          `,
            ...
            <div className="relative z-10 w-full max-w-md mx-4">
                ...
                <div
                    className="relative bg-brand-card/80 backdrop-blur-xl border border-white/[0.06] rounded-2xl p-8 sm:p-10 shadow-2xl shadow-black/50">
                    {/* Logo */}
