/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: eb4689724f642097a1524ac446518d7c)
// Runtime types generated with workerd@1.20260401.1 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TenantOrderDO";
	}
	interface LocalEnv {
		DB: D1Database;
		ENVIRONMENT: "local";
		...
		TENANT_ORDER_DO: DurableObjectNamespace<import("./src/index").TenantOrderDO>;
	}
	interface StagingEnv {
		DB: D1Database;
		ENVIRONMENT: "staging";
		CORS_ORIGIN: "https://staging.nummygo.ca";
		CUSTOMER_WEB_URL: "https://staging.nummygo.ca";
		BETTER_AUTH_URL: "https://api-staging.nummygo.ca";
		BETTER_AUTH_SECRET: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		RESEND_API_KEY: string;
	...
	interface ProductionEnv {
		...
		CORS_ORIGIN: "https://nummygo.ca";
		CUSTOMER_WEB_URL: "https://nummygo.ca";
		BETTER_AUTH_URL: "https://api.nummygo.ca";
		BETTER_AUTH_SECRET: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		RESEND_API_KEY: string;
	...
	interface Env {
		...
		CORS_ORIGIN?: "http://localhost:3000" | "https://staging.nummygo.ca" | "https://nummygo.ca";
		CUSTOMER_WEB_URL?: "http://localhost:3000" | "https://staging.nummygo.ca" | "https://nummygo.ca";
		BETTER_AUTH_URL?: "http://localhost:8787" | "https://api-staging.nummygo.ca" | "https://api.nummygo.ca";
		BETTER_AUTH_SECRET: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		RESEND_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CORS_ORIGIN" | "CUSTOMER_WEB_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY">> {}
}
